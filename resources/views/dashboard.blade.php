    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{asset('categories')}}" class="nav-link text-success">
          ...
          <li class="nav-item">
            <a href="{{asset('banners')}}" class="nav-link text-success">
          ...
          <li class="nav-item">
            <a href="{{asset('users')}}" class="nav-link text-success ml-1">
          ...
          <li class="nav-item">
            <a href="{{asset('coupons')}}" class="nav-link text-success">
          ...
          <li class="nav-item">
            <a href="{{asset('products')}}" class="nav-link text-success">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Product-Management
              </p>
